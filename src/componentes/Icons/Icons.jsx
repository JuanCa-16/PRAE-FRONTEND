...
const HomeIcon = ({ color = "#000", width = 30, height = 30, estado,activo, ...props }) => {
  ...
  return (
    ...
    >
      <path
        fill={estado || activo ? "#157AFE" : color} // Corrige la sintaxis del operador ternario
        fillRule="evenodd"
...
const AjustesIcon = ({ color = "#000", width = 30, height = 30, estado,activo, ...props }) => (
    <svg
    xmlns="http://www.w3.org/2000/svg"
    width={30}
    height={30}
...
const ListadoIcon = ({ color = "#000", width = 30, height = 30, estado,activo,...props }) => (
    <svg
    xmlns="http://www.w3.org/2000/svg"
    width={30}
    height={30}
...
const EstudianteIcon = ({ color = "#000", width = 30, height = 30, estado, activo, ...props }) => (
    <svg
    xmlns="http://www.w3.org/2000/svg"
    width={30}
    height={30}
  ...
  >
    <path
      stroke={estado || activo ? "#157AFE" : color} 
      strokeLinecap="round"
...
const TeacherIcon = ({ color = "#000", width = 30, height = 30, estado,activo,  ...props }) => (
    <svg
    xmlns="http://www.w3.org/2000/svg"
    width={16}
    height={18}
...
const GradosIcon = ({ color = "#000", width = 30, height = 30, estado,activo, ...props }) => (
    <svg
    xmlns="http://www.w3.org/2000/svg"
    width={30}
    height={30}
