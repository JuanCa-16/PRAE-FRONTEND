    ...
    return (
      ...
      >
        ...
        >
            ...
            {promedioTotal !== null ? (
                <div>
                    <PildoraEst color="morado" clase="peque pildoraEstadistica" est="PROMEDIO:" estadistica><AnimatedCounter from={0} to={promedioTotal} duration={duracion}  /></PildoraEst>
                </div>
            ...
            {cantidadMaterias !== null ? (
                <div>
                    <PildoraEst  clase="peque pildoraEstadistica" est="CANTIDAD MATERIAS:" estadistica><AnimatedCounter from={0} to={cantidadMaterias} duration={duracion}  /></PildoraEst>
                </div>
            ...
            {cantObservaciones !== null ? (
                <div>
                    <PildoraEst color="morado" clase="peque pildoraEstadistica" est="TOTAL OBSERVACIONES:" estadistica><AnimatedCounter from={0} to={cantObservaciones} duration={duracion}  /></PildoraEst>
                </div>
            ...
            {materiasAlto !== null ? (
                <div>
                    <PildoraEst color="amarillo" clase="peque pildoraEstadistica" est="MATERIAS EN ALTO:" estadistica><AnimatedCounter from={0} to={materiasAlto} duration={duracion}  /></PildoraEst>
                </div>
            ...
            {materiasMedia !== null ? (
                <div>
                    <PildoraEst color="morado" clase="peque pildoraEstadistica" est="MATERIAS EN MEDIO:" estadistica><AnimatedCounter from={0} to={materiasMedia} duration={duracion}  /></PildoraEst>
                </div>
            ...
            {materiasBajo !== null ? (
                <div>
                    <PildoraEst clase="peque pildoraEstadistica" est="MATERIAS EN BAJO:" estadistica><AnimatedCounter from={0} to={materiasBajo} duration={duracion}  /></PildoraEst>
                </div>
