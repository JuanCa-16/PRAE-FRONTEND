...
const CursosAsignadosDocente = ({idProfe, idInstitucion, url}) => {
    ...
    useEffect(() => {
        const listaCursos = async () => {
            try {
                const response = await fetch(`${API_URL}asignar/asignaciones/profesor/${idProfe}/institucion/${idInstitucion}`,{
                    method: "GET",
                    headers: {
    ...
    return (
            ...
            <TituloDes 
                ...
                <div className="informacion">
                    ...
                    <ContenedorMaterias url={url} est={false} info={pildorasFiltradas} idProfe={idProfe}></ContenedorMaterias>
