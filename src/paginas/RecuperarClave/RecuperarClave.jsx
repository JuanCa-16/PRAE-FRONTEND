            ...
            <div className=' pagRecuperar'>
                <div className="izq">
                    <div className='imagen_logo'>
                        ...
                        <div className='info'>
                            <img className="logo" src={emailLogo} alt="imges_logo" />
                ...
                <div className="der">
                    <div className='title'>
                        <TituloDes titulo="Recuperar Contraseña" desc='Digita el correo asociado a tu cuenta para recibir un enlace para reestablecerla.'></TituloDes>
                    </div>
                    <form onSubmit={handlerRecuperacion} className='Form_login'>
                        ...
                        <p className='lato_1' onClick={() => navigate("/login")}>Iniciar Sesión</p>
                        <div className='btn_login'><button type='submit' disabled={cargando}>{cargando? 'Enviando...': 'Enviar'}</button></div>
                    </form>
                </div>
            </div>
        </div>
